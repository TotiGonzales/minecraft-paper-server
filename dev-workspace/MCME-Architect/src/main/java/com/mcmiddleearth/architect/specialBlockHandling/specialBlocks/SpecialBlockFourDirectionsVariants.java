 ...
 * @author Eriol_Eandur
 */
public abstract class SpecialBlockFourDirectionsVariants extends SpecialBlockOrientableVariants {

    protected SpecialBlockFourDirectionsVariants(String id, String[] variants,
                                                 BlockData[][] data, SpecialBlockType type) {
        super(id, data, variants, SpecialBlockFourDirections.fourFaces, type);
    }
